...
public interface BubbleSortApi {
    ...
    ResponseEntity<IntArray> bubbleSortPost(@Parameter(in = ParameterIn.DEFAULT, description = "bubblesort", required=true, schema=@Schema()) @Valid @RequestBody List<Integer> body);
